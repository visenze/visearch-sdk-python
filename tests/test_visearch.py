...
class TestVisearch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.multiproductsearch_entpoint = "http://visearch.visenze.com/discoversearch"
    ...
    @httpretty.activate
    def test_multiproductsearch_valid_im_url_with_default_values(self):
        global active_mock_response
        ...
        resp = self.api.multiproductsearch(im_url="http://www.test.com/test.jpg")
    ...
    @httpretty.activate
    def test_multiproductsearch_valid_im_id_with_default_values(self):
        global active_mock_response
        ...
        resp = self.api.multiproductsearch(im_id="12345")
        send_params = self.get_request_params(request_callback.request)
    ...
    @httpretty.activate
    def test_multiproductsearch_valid_image_with_default_values(self):
        global active_mock_response
        ...
        resp = self.api.multiproductsearch(image=self.image_path)
        send_params = self.get_request_params(request_callback.request)

        self.assertTrue(len(send_params) > 1000) # have image content

    @httpretty.activate
    def test_multiproductsearch_valid_request_with_specified_values(self):
        global active_mock_response
